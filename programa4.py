...
imagen= cv2.imread('C:/Users/TereH/OneDrive/Escritorio/IA/ciculos.jpg')
...
param1= 50, param2=30, maxRadius=50
)
...
if circulos is not None:
    ...
    cv2.putText(imagen, "Referencia", (referencia_circulo[0] - 40, referencia_circulo[1] - referencia_circulo[2] - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255,0,0) ,2)
